...
import com.jacopocarlini.arco.model.ErrorResponse;
...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        var errorResponse = ErrorResponse.builder()
                .status(AppError.BAD_REQUEST.httpStatus.value())
                .title(AppError.BAD_REQUEST.title)
                .detail(AppError.BAD_REQUEST.details)
                .code(AppError.BAD_REQUEST.code)
                .build();
    ...
    public ResponseEntity<ErrorResponse> handleGenericException(final Exception ex, final WebRequest request) {
        ...
        var errorResponse = ErrorResponse.builder()
                .status(AppError.INTERNAL_SERVER_ERROR.httpStatus.value())
                .title(AppError.INTERNAL_SERVER_ERROR.title)
                .detail(AppError.INTERNAL_SERVER_ERROR.details)
                .code(AppError.INTERNAL_SERVER_ERROR.code)
                .build();
